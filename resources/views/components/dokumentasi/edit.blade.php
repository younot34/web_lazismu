...
<div class="page-body">
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-lg-10">
            <form action="{{ route('dokumentasi.update', $doks->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" value="" name="text" id="editor" class="form-control">{!! $doks->text !!}</textarea>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    class MyUploadAdapter {
            ...
            _initRequest() {
                ...
                // could be different.
                xhr.open( 'POST', '{{ route('dokumentasi.image.store') }}', true );
